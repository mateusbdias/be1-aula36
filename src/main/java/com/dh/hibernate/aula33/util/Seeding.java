package com.dh.hibernate.aula33.util;
...
public class Seeding implements ApplicationRunner {
    ...
    @Autowired
    public Seeding(TimeRepository timeRepository, JogadorRepository jogadorRepository) {
    ...
    public void run(ApplicationArguments args) {
        ...
        Time t5 = new Time("Avaí Futebol Clube", "Florianópolis", "SC");
        ...
        Jogador j9 = new Jogador("Cássio Ramos", "Goleiro", 75.4 , 1.96, t9);
        ...
        jogadorRepository.save(j11);
        jogadorRepository.save(j12);
        jogadorRepository.save(j13);
        jogadorRepository.save(j14);
        jogadorRepository.save(j15);
        jogadorRepository.save(j16);
        jogadorRepository.save(j17);
        jogadorRepository.save(j18);
        jogadorRepository.save(j19);
        jogadorRepository.save(j20);
